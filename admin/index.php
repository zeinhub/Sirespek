...
<head>
    ...
    ?>
        <title>Sirespek | Super Admin</title>
    <?php } else { ?>
        <title>Sirespek | Admin</title>
    <?php } ?>
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            ?>
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">SIRESPEK SUPER ADMIN</sup></div>
                </a>
            <?php } else { ?>
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">SIRESPEK ADMIN</sup></div>
                </a>
            <?php } ?>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Bengkel Tersedia</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="daftar-bengkel.php">
                                                    <?php
                                                    $sql    = "SELECT * FROM data_bengkel";
                                                    $query    = mysqli_query($conn, $sql);
                                                    $count    = mysqli_num_rows($query);
                                                    echo "$count"; ?></div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Butuh Validasi</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <a href="validasi.php">
                                                    <?php
                                                    $sql    = "SELECT * FROM transaksi WHERE status='Validasi Pembayaran'";
                                                    $query    = mysqli_query($conn, $sql);
                                                    $count    = mysqli_num_rows($query);
                                                    echo "$count"; ?>
                                                </a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Belum Selesai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <a href="on-progress.php">
                                                    <?php
                                                    $sql    = "SELECT * FROM transaksi WHERE NOT status='Validasi Pembayaran' AND NOT status='diambil'";
                                                    $query    = mysqli_query($conn, $sql);
                                                    $count    = mysqli_num_rows($query);
                                                    echo "$count"; ?>
                                                </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <a href="diambil.php">
                                                    <?php
                                                    $sql    = "SELECT * FROM transaksi WHERE status='diambil'";
                                                    $query    = mysqli_query($conn, $sql);
                                                    $count    = mysqli_num_rows($query);
                                                    echo "$count"; ?>
                                                </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="update_artikel.php"> Update</a></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Running Text</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="running-text.php"> Update</a></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Daftarkan Bengkel</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="input_bengkel.php">Daftar</a></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-text fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="informasi_pelanggan.php">Update</a></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-text fa-2x text-gray-300"></i>
                                        </div>
