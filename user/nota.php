...
if (!isset($_SESSION['username'])) {
    echo "<script>alert('Anda Harus Login Terlebih Dahulu Atau Anda Tidak Memiliki Hak Akses Ke halaman Ini!'); location.href=\"../login.php\";</script>";
    echo "Akses Ditolak!";
}
...
<body>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="desc"><?php echo $data['bengkel']; ?></td>
    ...
    <br>
    <a style="text-align: center; font-size:20px; float:right;" target="_blank" href="cetak.php">Cetak Laporan</a>
</body>
